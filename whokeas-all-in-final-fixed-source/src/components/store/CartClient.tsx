  ...
  if (items.length === 0) {
    return (
      <section className="bg-white p-8 shadow-sm">
        ...
        <Link
          href="/#products"
          className="mt-6 inline-block rounded-full bg-[#ff6a00] text-white px-6 py-3 text-sm font-bold hover:bg-[#e85f00]"
        >
          Continue shopping
        </Link>
      </section>
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[1fr_330px]">
            ...
            >
              ...
              <div>
                <Link
                  ...
                  className="text-lg font-bold hover:text-[#e85f00]"
                >
                  {item.name}
                </Link>
                ...
                <div className="mt-4 flex flex-wrap items-center gap-3">
                  ...
                  <button
                    ...
                    className="text-sm font-semibold text-[#ff6a00] hover:text-[#e85f00] hover:underline"
                  >
                    Delete
                  </button>
                </div>
      ...
      <aside className="h-fit bg-white p-5 shadow-sm lg:sticky lg:top-32">
        ...
        <Link
          href="/checkout"
          className="mt-5 block w-full rounded-full bg-[#ff6a00] text-white px-5 py-3 text-center text-sm font-bold shadow-sm hover:bg-[#e85f00]"
        >
          Proceed to Checkout
        </Link>
