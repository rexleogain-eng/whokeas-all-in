...
$migrationPath = Join-Path (Get-Location) "src\db\repair-product-media.ts"
[System.IO.File]::WriteAllText($migrationPath, $migration, $utf8)

Write-Host "Repairing Neon product media table..." -ForegroundColor Cyan
npx tsx .\src\db\repair-product-media.ts
...
Write-Host ""
Write-Host "Product media database repair completed." -ForegroundColor Green
Write-Host "Run: npm run dev" -ForegroundColor Yellow
Write-Host "Test: http://localhost:3000/products" -ForegroundColor Yellow
Write-Host "Test: http://localhost:3000/admin/products" -ForegroundColor Yellow
