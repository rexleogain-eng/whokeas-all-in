  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#d8cfbf] bg-[#fffdf8]/95 shadow-[0_10px_35px_rgba(28,24,18,0.06)] backdrop-blur">
      <div className="bg-[#12110f] px-4 py-2 text-center text-[10px] font-semibold uppercase tracking-[0.18em] text-[#d6bd7b] sm:text-xs">
        International catalogue · Market-aware pricing ·
        WHOKEAS order support
      </div>
      ...
      <div className="mx-auto grid max-w-[1580px] grid-cols-[auto_1fr_auto] items-center gap-3 px-4 py-4 lg:gap-7 lg:px-7">
        ...
        <form
          action="/products"
          className="mx-auto flex w-full max-w-3xl overflow-hidden border border-[#cfc4b1] bg-white focus-within:border-[#9b762c]"
        >
          <input
            name="q"
            defaultValue={query}
          ...
          <button className="border-l border-[#cfc4b1] bg-[#171512] px-4 text-xs font-bold uppercase tracking-[0.12em] text-white hover:bg-[#9b762c] sm:px-7">
            Search
          </button>
        </form>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/account"
            className="border border-[#cfc4b1] bg-[#fffdf8] px-3 py-3 text-[10px] font-black uppercase tracking-[0.12em] text-[#171512] hover:border-[#9b762c] hover:text-[#9b762c]"
          >
            Account
          </Link>
      ...
      <nav className="border-t border-[#e6ded1] bg-[#f7f2e9]">
        <div className="mx-auto flex max-w-[1580px] items-center gap-7 overflow-x-auto px-4 py-3 text-[11px] font-bold uppercase tracking-[0.16em] text-[#514a40] lg:px-7">
          <Link
            href="/products"
            className="shrink-0 text-[#9b762c] hover:text-[#171512]"
          >
            Shop all
          </Link>
